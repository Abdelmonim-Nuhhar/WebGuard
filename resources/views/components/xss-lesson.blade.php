<div class="p-4 m-2 rounded-lg shadow-lg bg-gray-100 font-mono">
    <div class="text-base mb-4 bg-white p-4 rounded-2xl">
        <p class="text-gray-700 p-4 font-bold text-base font-mono">
            Welcome back, <span class="text-red-600">{{ Auth::user()->name }}</span>, to the Cross-Site Scripting (XSS) Section.
        </p>
        <hr class="my-2 border-blue-800">
        <p class="mb-3 text-lg font-bold"><span class="text-gray-500">Introduction</span></p>
        <hr class="my-2 border-blue-800">
        <div class="text-base mb-4 bg-white p-4 rounded-2xl">
            <p>
            {{ $slot }}
        ...
        <p class="mb-3 text-lg font-bold"><span class="text-blue-500">XSS TYPES</span></p>
        <hr class="my-2 border-blue-800">

        <p class="mb-3 text-lg font-bold"><span class="text-yellow-500">1- Stored XSS (Persistent XSS):</span></p>
        <hr class="my-2 border-blue-800">
        <div class="text-base mb-4 bg-white p-4 rounded-2xl">
            <p>
        ...
        <p class="mb-3 text-lg font-bold"><span class="text-red-500">2- Reflected XSS (Non-Persistent XSS):</span></p>
        <hr class="my-2 border-blue-800">
        <div class="text-base mb-4 bg-white p-4 rounded-2xl">
            <p>
        ...
        <p class="mb-3 text-lg font-bold"><span class="text-red-800">3- DOM-based XSS:</span></p>
        <hr class="my-2 border-blue-800">
        <div class="text-base mb-4 bg-white p-4 rounded-2xl">
            <p>
